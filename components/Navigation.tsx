      ...
      <Link href={href}>
        <Button
          className={classNames(
            ...
            "lg:text-md block w-full cursor-pointer select-none rounded py-6 text-sm text-white/80 ring-white/50 transition-all focus:outline-none focus:ring-2 xl:text-lg"
          )}
        >
          {children}
        </Button>
